# Dockerfile
#
# docker run --rm --interactive --tty helje5/rpi-raspbian-swift-build311-env bash
# 
# TODO: need a script within the image for this:
# docker run --rm -v /home/pirate:/package helje5/rpi-raspbian-swift311-build \
...
FROM helje5/rpi-raspbian-swift-build311-env
